...
from funcarve_utils_gmm import *
...
args.add_argument('--upper', default=0.8, help='Upper threshold for predscore')
args.add_argument('--lower', default=0.5, help='Lower threshold for predscore')
args.add_argument('--maxweight', default=100, help='Maximum weight for reactions')
args.add_argument('--minweight', default=0.0, help='Minimum weight for reactions')
