...
parser.add_argument('--file_type', default=7, help='Input file type: cleandf=1,  fasta=2')
parser.add_argument('--cleanfile', default='none')
parser.add_argument('--reward', default=0.1, help='reward for new reactions')
parser.add_argument('--iter', default = 3, help='The number of iterations to run the funcarve algorithm')
parser.add_argument('--threshold', default = 8, help='The cutoff value for the EC prediction score')
parser.add_argument('--block_flage', default = 1, help='decrease block reactions: 1, ignore block reactions: 0')
...
parser.add_argument('--upper', default=15, help='Upper threshold for predscore')
parser.add_argument('--lower', default=5, help='Lower threshold for predscore')
parser.add_argument('--maxweight', default=100, help='Maximum weight for reactions')
parser.add_argument('--minweight', default=0.0, help='Minimum weight for reactions')
...
def read_cleandf_withscore(input_file,threshold=5):
    ...
    for i in range(1,int(inter)+1):
        ...
        if file_type == 2:
            if i ==1:
                ...
                print('No CLEAN results yet... start from fasta file')
